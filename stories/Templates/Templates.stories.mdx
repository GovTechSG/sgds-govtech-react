    ...
    <>
      ...
      <Accordion defaultActiveKey="0" className="mx-md-8 shadow">
        ...
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body className="p-5">
            <Col sm={8}>
              <Form.Group className="mb-4" controlId="formCollapsibleDatepicker1">
                <Form.Label>Label</Form.Label>
                <DatePicker />
              </Form.Group>
  ...
  return (
    <div>
      ...
      <Navbar className="mt-4" expand="lg">
        <Navbar.Brand href="">
          <img src="https://www.developer.tech.gov.sg/assets/img/logo_color.svg" alt="Home" />
        </Navbar.Brand>
          ...
          <Nav className="me-auto" navbarScroll activeKey={active}>
            ...
            <Nav.Item>
              <Nav.Link
                href=""
                eventKey="components"
                onClick={() => clickNavbarItem('components')}
              >
                Components
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link
                href=""
                eventKey="patterns"
                onClick={() => clickNavbarItem('patterns')}
              >
                Patterns
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link
                href=""
                eventKey="templates"
                onClick={() => clickNavbarItem('templates')}
              >
                Templates
              </Nav.Link>
            </Nav.Item>
            <NavDropdown
              ...
              id="theme-customiser"
              eventKey="theme customiser"
              onClick={() => clickNavbarItem('theme customiser')}
            >
              <NavDropdown.Item
                href=""
                onClick={() => clickNavbarItem('theme customiser')}
...
<Canvas>
  <Story name="Detail Page Basic">
    {DetailBasicTemplate.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Detail Page Side Nav">
    {DetailSideNavTemplate.bind({})}
  </Story>
</Canvas>
      ...
      <Row className="my-8 me-8">
        ...
        <Col lg="2" className="d-none d-lg-block">
            ...
            <ul style={{listStyle: "none"}}>
              <li>
                <a href="" className="text-decoration-none">Page heading</a>
              </li>
              <ul style={{listStyle: "none"}}>
                <li>
                  <a href="" className="text-decoration-none">Overview</a>
                </li>
              </ul>
            </ul>
        </Col>
