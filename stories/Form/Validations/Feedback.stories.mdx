  ...
  return (
    <Form noValidate validated={true}>
      <Form.Group md="4" controlId="textOnlyInput">
        ...
        <Form.Text className="text-muted" id="lettersOnlyHint">
        ...
        <Form.Control
          ...
          pattern="[a-zA-Z]*"
          aria-describedby="lettersOnlyHint"
          aria-errormessage="lettersOnlyErr"
          defaultValue="Lorem Ipsum 123"
        />
        <Form.Control.Feedback type="invalid" id="lettersOnlyErr">
          Name is invalid or empty
        </Form.Control.Feedback>
      </Form.Group>
      <Form.Group md="4" controlId="requiredInput">
        <Form.Label>First name</Form.Label>
        <Form.Text className="text-muted" id="requiredInputHint">
          Input is required
        </Form.Text>
        <Form.Control
          type="text"
          placeholder="First name"
          required
          aria-describedby="requiredInputHint"
        />
      ...
      <Form.Group md="4" controlId="minLengthFiveInput">
        <Form.Label>First name</Form.Label>
        <Form.Text className="text-muted" id="minLenFiveHint">
          Minimum length of 5
        </Form.Text>
        <Form.Control
          type="text"
          placeholder="First name"
          minLength="5"
          aria-describedby="minLenFiveHint"
