...
import { Form, Button, Col, InputGroup, Row } from '../../../src/index';
import * as yup from 'yup';
import * as formik from 'formik';

<Meta title="Components/Form/Validations" component={Form} />

export const templateCode_Native = `
...
export const templateCode_Formik = `
...
```jsx
import { Form, Button, Col, InputGroup, Row } from '@govtechsg/sgds-react';

// For Formik, import formik/yup after installation
import * as yup from 'yup';
import * as formik from 'formik';
```
...
<Canvas>
  <Story
    name="Formik Validation"
    parameters={{
      docs: {
        source: {
          code: templateCode_Formik,
        },
        type: 'code',
      },
    }}
