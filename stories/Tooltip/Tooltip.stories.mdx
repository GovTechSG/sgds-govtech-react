...
export const img = 
    <img src="https://www.pngitem.com/pimgs/m/122-1228795_mr-poopybutthole-rick-and-morty-png-download-bill.png" width="100" height="100" />

<Canvas>
  <Story name="Image content" args={{content: img}}>{defaultTooltip}</Story>
</Canvas>
