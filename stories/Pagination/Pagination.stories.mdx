...
export const templateCodeAlternativeSizes = `
<Pagination
  size="md"
  ...
/>
...
export const templateCodeDirectionVariant = `
<Pagination
...
export const templateCodeSettingLimit = `
export const DUMMY_DATA = [
  {
    userId: 1,
    id: 1,
...
export const templateCodeEllipsis = `
<Pagination
ellipsisOn={true}
...
/>
...
export const templateCodeEllipsisJump = `
<Pagination
ellipsisOn={true}
ellipsisJump={5}
...
...
<Story name="Basic">{PaginationWTableTpl.bind({})}</Story>
...
<Canvas>
  <Story
    ...
    parameters={{
      docs: {
        source: {
          code: templateCodeAlternativeSizes,
        },
        type: 'code',
      },
    }}
...
<Canvas>
  <Story
    name="Direction Variant icon-text"
    parameters={{
      docs: {
        source: {
          code: templateCodeDirectionVariant,
        },
        type: 'code',
      },
    }}
  ...
  <Story
    name="Direction Variant text"
    args={{ directionVariant: 'text' }}
    parameters={{
      docs: {
        source: {
          code: '',
  ...
  <Story
    name="Direction Variant icon"
    args={{ directionVariant: 'icon' }}
    parameters={{
      docs: {
        source: {
          code: '',
...
By setting the limit to **3** or **5** or **8**, it will show the number of pages equal to the particular limit given. Do **_note_** that if limit is set to be of higher value than the total pages for the pagination, it will just render the total pages at one go, ignoring the limit.
...
<Canvas>
  <Story
    name="Ellipsis Jump - 3"
    args={{ ellipsisOn: true, ellipsisJump: 3 }}
    parameters={{
      docs: {
        source: {
          code: templateCodeEllipsisJump,
        },
        type: 'code',
      },
    }}
  ...
  <Story
    name="Ellipsis Jump - 5"
    args={{ ellipsisOn: true, ellipsisJump: 5 }}
    parameters={{
      docs: {
        source: {
          code: '',
  ...
  <Story
    name="Ellipsis Jump - 8"
    args={{ ellipsisOn: true, ellipsisJump: 8 }}
    parameters={{
      docs: {
        source: {
          code: '',
