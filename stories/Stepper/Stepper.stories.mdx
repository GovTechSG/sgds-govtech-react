...
The default Stepper component consist of step markers and step details. The step markers consist of three states, inactive, active and done, indicated by the colors: grey, border-purple and filled-purple respectively.
...
Import `useStep` hook from `sgds-react`

```jsx
import { useStep } from 'sgds-react';
```
...
```jsx
import { useStep, StepMetadata, Stepper } from 'sgds-react'
...
```jsx
import { useStep, StepMetadata, Stepper, UseStepMethods } from 'sgds-react'
