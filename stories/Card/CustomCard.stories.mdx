...
Or build your own Quantity Toggle Card without the used of the variant attribute. Use `Row` and `Col` to position your contents accordingly
...
<Canvas>
  <Story name="Quantity Toggle Card">{QtyToggleTemplate.bind({})}</Story>
</Canvas>
