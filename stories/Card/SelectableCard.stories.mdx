...
<Meta
  ...
  argTypes={{
    ...
    onChange: {
      description:
        'HTMLInputElement event handler to update states or any side effect actions',
    },
  }}
/>
...
<Canvas>
  <Story name="Default SelectableCard">
    {(args) => (
      <Row>
        <Col xs>
          <SelectableCard {...args} aria-label="selectablecard">{AppleBody}</SelectableCard>
        </Col>
        <Col xs>
          <></>
        </Col>
...
<Canvas>
  <Story name="Types">
    {() => (
      <Row>
        <Col xs>
          <SelectableCard type="checkbox" aria-label="selectablecard">
            {AppleBody}
          </SelectableCard>
        </Col>
        <Col xs>
          <SelectableCard type="radio" aria-label="selectablecard">
            {AppleBody}
          </SelectableCard>
        </Col>
        <Col xs>
          <SelectableCard type="switch" aria-label="selectablecard">
            {AppleBody}
          </SelectableCard>
        </Col>
      </Row>
