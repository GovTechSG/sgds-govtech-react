...
<Canvas>
  <Story name="Range Selection" args={{ mode: 'range' }} height="380px">
    {DatePickerTemplate.bind({})}
  </Story>
</Canvas>
...
import {DatePicker, RangeSelectionValue} from '@govtechsg/sgds-govtech-react/DatePicker'
...
### onFocus, onBlur , onClear, onChangeDate

`onFocus` , `onBlur` , `onClear`, `onChangeDate` of the input, perform a callback.

<Canvas>
  <Story
    name="onFocus"
    args={{ onFocus: () => alert('focused!'), placeholder: 'focus me' }}
    height="380px"
  >
    {DatePickerTemplate.bind({})}
  </Story>
  <Story
    name="onBlur"
    args={{ onBlur: () => alert('blurred!'), placeholder: 'blur me' }}
    height="380px"
  >
    {DatePickerTemplate.bind({})}
  </Story>
  ...
  <Story
    name="onChangeDate"
    args={{
      onChangeDate: (date) => alert(`selected ${date.toISOString()}`),
  ...
  <Story
    ...
    args={{
      ...
      onChangeDate: ({ start, end }) =>
        alert(
          `selected start: ${start.toISOString()}, end: ${end.toISOString()}`
        ),
...
```jsx
//onFocus
<DatePicker onFocus={() => alert('focused!')} />
  //onBlur
<DatePicker onBlur={() => alert('blurred!')} />
  //onClear
<DatePicker onClear={() => alert('cleared!')} />
    //onChangeDate single mode
<DatePicker onChangeDate={(date) => alert(`selected ${date.toISOString()}`)} />
