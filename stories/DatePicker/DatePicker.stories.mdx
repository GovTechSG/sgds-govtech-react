...
<Canvas>
  <Story name="Range Selection" args={{ mode: 'range' }} height="500px">
    {(args) => {
      ...
      const minDate = new Date(2020, 10, 11, 12, 0, 0, 0).toISOString();
      const maxDate = new Date(2020, 10, 13, 12, 0, 0, 0).toISOString();
      return <DatePicker mode="range" {...args} />;
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Initial Value for Multi" height="500px">
    {() => {
      const [date, setDate] = useState(new Date('2020-01-01'));
      const ref = React.createRef();
      const handleChange = (value) => {
...
<Canvas>
  <Story name="onClear" height="500px">
    {() => {
      const [date, setDate] = useState(new Date('2020-01-01'));
      const ref = React.createRef();
      const handleChange = (value) => {
      ...
      const maxDate = new Date(2020, 10, 13, 12, 0, 0, 0).toISOString();
      return (
        <DatePicker onClear={() => alert('cleared')} placeholder="clear me" />
      );
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="onChangeDate" height="500px">
    {() => {
      const [date, setDate] = useState(new Date('2020-01-01'));
      const ref = React.createRef();
      const handleChange = (value) => {
      ...
      return (
        <DatePicker
          onChangeDate={(date) =>
            alert(`selected ${date ? date.toISOString() : ''}`)
          }
...
<Canvas>
  <Story name="onChangeDate Range" height="500px">
    {() => {
      const [date, setDate] = useState(new Date('2020-01-01'));
      const ref = React.createRef();
      const handleChange = (value) => {
