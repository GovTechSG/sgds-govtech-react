...
You can use the as prop to render whatever your heart desires. sgds-govtech-react will take care of the proper ARIA roles for you.
...
sgds-govtech-react will prevent any `onClick` handlers from firing regardless of the rendered element.
