...
export const templateCode_Nav = `import {
  Navbar,
  Nav,
  Col,
  Row,
...
export const templateCode_NavDefaultActive = `import {
  Navbar,
  Nav,
  Col,
  Row,
...
export const templateCode_NavActive = `
...
<Canvas>
  <Story
    ...
    parameters={{
      docs: {
        source: {
          code: templateCode_NavDefaultActive,
        },
        type: 'code',
      },
    }}
