...
export const templateCodeNav = `import {
  Navbar,
  Nav,
  Col,
  Row,
...
export const templateCodeNavDefaultActive = `import {
  Navbar,
  Nav,
  Col,
  Row,
...
export const templateCodeNavActive = `
...
<Canvas>
  <Story
    ...
    parameters={{
      docs: {
        source: {
          code: templateCodeNavDefaultActive,
        },
        type: 'code',
      },
    }}
