...
<Meta
  ...
  argTypes={{
    ...
    activeKey: {
      description:
        'Marks the Nav item with a matching eventKey (or href if present for NavLink) as active.',
      table: {
        category: `<Nav />`,
      },
  ...
  return (
    <Nav {...args}>
      ...
      <Nav.Dropdown
        ...
        href="#"
      >
        <Nav.Dropdown.Item eventKey="4.1">
          Action
        </Nav.Dropdown.Item>
...
export const ActiveKeyTemplate = () => {
  ...
  const handleClick = (ek) => {
    setActiveK(ek);
  };
  return (
    <Nav defaultActiveKey="5" activeKey={activeK}>
      <Nav.Item>
        <Nav.Link onClick={() => handleClick('link-1')} eventKey="link-1">
          Link
        </Nav.Link>
      </Nav.Item>
      <Nav.Dropdown
      ...
      >
        <Nav.Dropdown.Item onClick={() => handleClick('4')} eventKey="4.1">
          Action
        </Nav.Dropdown.Item>
        <Nav.Dropdown.Item onClick={() => handleClick('4')} eventKey="4.2">
          Another action
        </Nav.Dropdown.Item>
        <Nav.Dropdown.Item onClick={() => handleClick('4')} eventKey="4.3">
          Something else here
        </Nav.Dropdown.Item>
        <Nav.Dropdown.Divider />
        <Nav.Dropdown.Item onClick={() => handleClick('4')} eventKey="4.4">
          Separated link
        </Nav.Dropdown.Item>
      </Nav.Dropdown>
      <Nav.Dropdown
...
<Nav>
  ...
  <Nav.Dropdown eventKey="4" title="Dropdown" id="nav-dropdown" href="#">
  ...
  <Nav.Dropdown eventKey="5" isMegaMenu title="Megamenu" id="nav-mega" href="#">
    <Container>
      <Row>
        <Col>
...
```jsx
export const ActiveKeyTempla = (args) => {
  const [activeK, setActiveK] = React.useState('4');
  const handleClick = (ek) => {
    setActiveK(ek);
  };
  return (
    <Nav {...args} defaultActiveKey="5" activeKey={activeK}>
      <Nav.Item>
        <Nav.Link onClick={() => handleClick('link-1')} eventKey="link-1">
          Link
        </Nav.Link>
