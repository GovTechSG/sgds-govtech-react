...
export const templateCode_Navbar = `
...
export const templateCode_AddNav = `
<Navbar>
  <Navbar.Brand href="#">{brandName}</Navbar.Brand>
  <Navbar.Toggle aria-controls="basic-navbar-nav" />
  <Navbar.Collapse id="basic-navbar-nav">
...
<Canvas>
  <Story
    name="Add Nav to Navbar"
    args={{ expand: 'lg' }}
    parameters={{
      docs: {
        source: {
          code: templateCode_AddNav,
        },
        type: 'code',
      },
    }}
