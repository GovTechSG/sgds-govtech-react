...
Create a fixed navbar along the top or bottom of the screen, that scrolls with the page. A convenience prop for the fixed-* positioning classes.`,
    ...
    bg: {
      description: 'Sets the background color of navbar. See [bootstrap colors](https://getbootstrap.com/docs/5.0/utilities/colors/) for possible options',
    },
  }}
/>
...
<Canvas>
  <Story name="Default" height="500px">{Default.bind({})}</Story>
</Canvas>
