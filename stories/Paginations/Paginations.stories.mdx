...
import { Paginations, Table } from '../../src/components/index';
...
<Meta
  ...
  argTypes={{
    ...
    ellipsisJump: {
      description:
        'When ellipsisOn is activated, length of decrementing/incrementing of pages can be set with a number value.',
    },
...
```jsx
import { Paginations, Table } from 'sgds-govtech-react';
