...
<Meta
  ...
  argTypes={{
    ...
    centeredAlignVariant: {
      description: 'A variant where contents of Modal are aligned to center.',
    },
  }}
/>
...
<Story name="Centered Contents" args={{centeredAlignVariant:true}}>
  {defaultModal.bind({})}
</Story>
...
<Modal show={show} onHide={handleClose} centeredAlignVariant>
  ...
</Modal>;
```
