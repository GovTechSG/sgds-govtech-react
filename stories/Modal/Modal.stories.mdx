...
export const templateCodeModal = `
 const DefaultModal = () => {
    const [show, setShow] = useState(false);
    const handleClose = () => setShow(false);
    const handleShow = () => setShow(true);
...
`;
export const templateCodeSizes = `
...
`;
export const templateCodeCustomDialog = `<Modal show={show} onHide={handleClose} dialogClassName="text-primary">
  ...
</Modal>;`;
export const templateCodeCustomContent = `<Modal show={show} onHide={handleClose} contentClassName="text-warning">
  ...
</Modal>;`;
export const templateCodeCustomBackdrop = `<Modal show={show} onHide={handleClose} backdropClassName="bg-primary">
  ...
</Modal>;`;
export const templateCodeNoAnimation = `<Modal show={show} onHide={handleClose} animation={false}>
  ...
</Modal>;`;
export const templateCodeCentered = `<Modal show={show} onHide={handleClose} centeredAlignVariant>
  ...
</Modal>;`;
...
<Canvas>
  <Story
    ...
    parameters={{
      docs: {
        source: {
          code: templateCodeCustomContent,
        },
        type: 'code',
      },
    }}
...
<Canvas>
  <Story
    ...
    parameters={{
      docs: {
        source: {
          code: templateCodeCustomBackdrop,
        },
        type: 'code',
      },
    }}
