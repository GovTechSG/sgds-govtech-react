...
export const Template = (args) => (
  <SideNav {...args} activeNavLinkKey="test5">
    <SideNav.Item eventKey="0" activeLinkKey="test1">
      <SideNav.Button>SideNav Item #1</SideNav.Button>
      <SideNav.Collapse>
        <SideNav.Link eventKey="test" href="#">number one</SideNav.Link>
        <SideNav.Link eventKey="test1"  href="#">number one</SideNav.Link>
        <SideNav.Link eventKey="test2" href="#">number one</SideNav.Link>
      </SideNav.Collapse>
    </SideNav.Item>
    <SideNav.Item eventKey="1" activeLinkKey="test5">
      <SideNav.Button>SideNav Item #2</SideNav.Button>
      <SideNav.Collapse>
        <SideNav.Link eventKey="test3" >number two</SideNav.Link>
        <SideNav.Link disabled eventKey="test4" >number two</SideNav.Link>
        <SideNav.Link eventKey="test5" >number two</SideNav.Link>
        <SideNav.Link eventKey="test6" >number two</SideNav.Link>
        <SideNav.Link eventKey="test7" >number two</SideNav.Link>
      </SideNav.Collapse>
    </SideNav.Item>
