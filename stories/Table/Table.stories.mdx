...
export const Basic = (args) => {
  return (
    <Table striped bordered hover {...args}>
      <thead>
        <tr>
          <th>#</th>
          <th>First Name</th>
