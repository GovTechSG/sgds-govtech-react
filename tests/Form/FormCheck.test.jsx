...
describe('<FormCheck>', () => {
  ...
  it('should support inline', () => {
    ...
    expect(
      screen.getByRole('checkbox').classList.contains('form-check-inline')
    );
  });

  it('should support isValid', () => {
    render(<FormCheck isValid label="My label" />);

    expect(screen.getByRole('checkbox').classList.contains('is-valid'));
  });

  it('should support isInvalid', () => {
    render(<FormCheck isInvalid label="My label" />);
  ...
  it('should support switches', () => {
    ...
    expect(
      container.querySelector('input[type="checkbox"].form-check-input')
    ).not.toBeNull();
  ...
  it('should support "as"', () => {
    ...
    const { container } = render(<FormCheck as={Surrogate} label="My label" />);
    expect(
      container.querySelector('input.extraClass[type="checkbox"]')
    ).not.toBeNull();
  });
