...
describe('<Dropdown.Item>', () => {
  ...
  it('menu item has outer element li', () => {
    const { getByText } = render(
      <Dropdown.Item href="/herpa-derpa">Item</Dropdown.Item>
    );
    expect(getByText('Item').parentElement?.tagName).toBe('LI');
    expect(getByText('Item').tagName).toBe('A');
  });
